package com.kindergartens.android.kindergartens.core.modular.checkupdate;
...
import com.kindergartens.android.kindergartens.core.ui.BaseCheckDialog;
...
//        Toast.makeText(this, "重写此方法显示自定义对话框", Toast.LENGTH_SHORT).show();
    ...
    private void customVersionDialogTwo() {
        versionDialog = new BaseCheckDialog(this, R.style.BaseDialog, R.layout.custom_dialog_two_layout);
        TextView tvTitle = versionDialog.findViewById(R.id.tv_title);
        TextView tvMsg = versionDialog.findViewById(R.id.tv_msg);
        Button btnUpdate = versionDialog.findViewById(R.id.btn_update);
...
//        finish();
    ...
    protected void onResume() {
        super.onResume();
        BaseActivity.setRunActivity(this);
        BaseActivity.getActivists().add(this);
    }

    @Override
    protected void onPause() {
        super.onPause();
        BaseActivity.getActivists().remove(this);
    }
}
