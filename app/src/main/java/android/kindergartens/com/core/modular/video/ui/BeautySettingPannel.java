...
//    };
    ...
    public BeautySettingPannel(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(context).inflate(android.kindergartens.com.R.layout.beauty_pannel, this);
        mContext = context;
        initView(view);
    }
    ...
    private void initView(View view) {
        mThirdGradleSeekBar = (SeekBar) view.findViewById(android.kindergartens.com.R.id.ThirdGradle_seekbar);
        mThirdGradleSeekBar.setOnSeekBarChangeListener(this);

        mFirstGradlePicker = (TXHorizontalPickerView) view.findViewById(android.kindergartens.com.R.id.FirstGradePicker);
        mSecondGradlePicker = (TXHorizontalPickerView) view.findViewById(android.kindergartens.com.R.id.secondGradePicker);

        mSeekBarLL = (LinearLayout) view.findViewById(android.kindergartens.com.R.id.layoutSeekBar);

        mSeekBarValue = (TextView) view.findViewById(android.kindergartens.com.R.id.TextSeekBarValue);
...
//                break;
    ...
    private void setFilter(int index) {
        ...
        switch (index) {
            case 1:
                bmp = decodeResource(getResources(), android.kindergartens.com.R.drawable.filter_langman);
                break;
            case 2:
                bmp = decodeResource(getResources(), android.kindergartens.com.R.drawable.filter_qingxin);
                break;
            case 3:
                bmp = decodeResource(getResources(), android.kindergartens.com.R.drawable.filter_weimei);
                break;
            case 4:
                bmp = decodeResource(getResources(), android.kindergartens.com.R.drawable.filter_fennen);
                break;
            case 5:
                bmp = decodeResource(getResources(), android.kindergartens.com.R.drawable.filter_huaijiu);
                break;
            case 6:
                bmp = decodeResource(getResources(), android.kindergartens.com.R.drawable.filter_landiao);
                break;
            case 7:
                bmp = decodeResource(getResources(), android.kindergartens.com.R.drawable.filter_qingliang);
                break;
            case 8:
                bmp = decodeResource(getResources(), android.kindergartens.com.R.drawable.filter_rixi);
                break;
            default:
                bmp = null;
                break;
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        if (seekBar.getId() == android.kindergartens.com.R.id.ThirdGradle_seekbar){
