...
class MusicListAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = mInflater.inflate(android.kindergartens.com.R.layout.audio_ctrl_music_item,null);
            holder = new MusicListView.ViewHolder();
            holder.name = (TextView) convertView.findViewById(android.kindergartens.com.R.id.xml_music_item_name);
            holder.duration = (TextView) convertView.findViewById(android.kindergartens.com.R.id.xml_music_item_duration);
            holder.selected = (ImageView) convertView.findViewById(android.kindergartens.com.R.id.music_item_selected);
