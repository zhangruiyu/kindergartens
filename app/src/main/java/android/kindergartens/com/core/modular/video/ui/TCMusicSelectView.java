...
public class TCMusicSelectView extends LinearLayout{
    ...
    public void init(TCAudioControl audioControl, List<TCAudioControl.MediaEntity> data){
        ...
        LayoutInflater.from(mContext).inflate(android.kindergartens.com.R.layout.audio_ctrl_music_list,this);
        mMusicList = (MusicListView)findViewById(android.kindergartens.com.R.id.xml_music_list_view);
        mMusicList.setData(data);
        mBtnAutoSearch = (Button)findViewById(android.kindergartens.com.R.id.btn_auto_search);
        atTitle = (TCActivityTitle)findViewById(android.kindergartens.com.R.id.xml_music_select_activity);
