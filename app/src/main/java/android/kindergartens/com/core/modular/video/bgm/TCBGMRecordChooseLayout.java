package android.kindergartens.com.core.modular.video.bgm;
...
public class TCBGMRecordChooseLayout extends RelativeLayout {
    ...
    private void init() {
        View view = View.inflate(getContext(), android.kindergartens.com.R.layout.layout_chose_music, this);
        mRlRoot = (RelativeLayout) view.findViewById(android.kindergartens.com.R.id.chose_rl_root);
        mRlEmpty = (RelativeLayout) view.findViewById(android.kindergartens.com.R.id.chose_rl_empty);
        mRecyclerView = (RecyclerView) view.findViewById(android.kindergartens.com.R.id.chose_rv_music);
        mRlLoading = (RelativeLayout) view.findViewById(android.kindergartens.com.R.id.chose_rl_loading_music);
        initMusicList();
    }
